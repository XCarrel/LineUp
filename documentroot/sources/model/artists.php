...
function getArtists()
{
    ...
    return [
        [
            ...
            "imageurl" => "artists-main-kaleo.jpg"
        ],
        [
            "id" => 1,
            "name" => "Txarango",
            ...
            "imageurl" => "artists-main-txarango.jpg"
        ],
        [
            "id" => 2,
            "name" => "Nekfeu",
            ...
            "imageurl" => "artists-main-nekfeu.jpg"
        ],
        [
            "id" => 3,
            "name" => "Eddy de Pretto",
            ...
            "imageurl" => "artists-main-eddydepretto.jpg"
        ],
        [
            "id" => 4,
            "name" => "Danitsa",
            ...
            "imageurl" => "arists-main-danitsa.jpg"
        ]
    ];*/
}
